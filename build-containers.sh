...
docker build --build-arg version=${VARNISH_VERSION} --build-arg mode=origin  -f Dockerfile.varnish -t docker.artifactory.futurenet.com/tjackson02/evha-edge-varnish:${IMAGE_TAG} .
